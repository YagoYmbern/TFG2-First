 ...
 * @author olao
 */
public class AdmixtureModel2 extends DemographicModel{

    public AdmixtureModel2(ParametersGenome pg) throws ParameterException, ParameterException, ExceptionPopulation, ExceptionDemography {
        super(pg);
    }
    ...
    public void defineDemography() throws ParameterException, ExceptionDemography, ExceptionPopulation {
        ...
        String[] names = {"African", "European", "X", "Neanderthal", "Denisovan"};
        ...
        int[] sample_size = {1, 1, 1, 1, 1};
        // times when the samples are sampled
        int[] times = {0, 0, 0, 1800, 1414};
        // Create the painting
        for (int p = 0; p < names.length; p++) {
            ...
            boolean shallICheckTheAncestralityInThisPopulation = names[p].equals("X");
...
//        ModelParameter tSplitHumanNeanderthal = new ModelParameter("tSplitHumanNeanderthal", new RandomUniform(tIntrogressionNeanderthal_Europe, new ModelParameter(new FixedValue(10000))));
    ...
    public static void main(String[] args) throws Exception {
        ...
        pg.add(new ParametersChromosome(1000000, m)); // We add to the list of the parameters the mutations and "kilobases"       
        AdmixtureModel2 a = new AdmixtureModel2(pg); // Create an object that contains the previous parameters
